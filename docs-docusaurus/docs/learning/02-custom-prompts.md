...
Respond with ONLY the category name. Goal: {goal}","{""provider"": ""anthropic"", ""model"": ""claude-sonnet-4-6"", ""temperature"": 0.1}"
...
Remember: Small consistent actions compound into extraordinary results! 💪","{""provider"": ""anthropic"", ""model"": ""claude-sonnet-4-6"", ""temperature"": 0.4}"
...
Your career is a marathon, not a sprint - let's build sustainable momentum! 🚀","{""provider"": ""anthropic"", ""model"": ""claude-sonnet-4-6"", ""temperature"": 0.3}"
...
Remember: The best learning happens when you actively apply what you're studying! 🎓","{""provider"": ""anthropic"", ""model"": ""claude-sonnet-4-6"", ""temperature"": 0.3}"
...
Your goal is part of your larger life story - let's make it a chapter worth writing! ✨","{""provider"": ""anthropic"", ""model"": ""claude-sonnet-4-6"", ""temperature"": 0.5}"
...
```csv
SmartGoals,ClassifyGoal,AI classifies the goal category,llm,RouteToCoach,ErrorHandler,goal,goal_category,"You are a goal classification expert...","{""provider"": ""anthropic"", ""model"": ""claude-sonnet-4-6"", ""temperature"": 0.1}"
```
...
Remember: Building wealth is about consistent, smart decisions over time! 💪","{""provider"": ""anthropic"", ""model"": ""claude-sonnet-4-6"", ""temperature"": 0.3}"
```
...
```json
{"provider": "anthropic", "model": "claude-sonnet-4-6", "temperature": 0.6}
```
