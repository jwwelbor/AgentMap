...
### LLMAgent  
```csv
PersonalGoals,AnalyzeGoal,AI analysis of the goal,llm,SaveGoal,ErrorHandler,goal,analysis,"You are a personal development coach...","{""provider"": ""anthropic"", ""model"": ""claude-sonnet-4-6"", ""temperature"": 0.3}"
```
...
```json
{"provider": "anthropic", "model": "claude-sonnet-4-6", "temperature": 0.8}
```
