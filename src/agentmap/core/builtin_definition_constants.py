...
class BuiltinDefinitionConstants:
    ...
    AGENTS = {
        ...
        "file_reader": {
            ...
            "category": "storage",
            "storage_type": "file",
            "requires": ["logging_service", "storage_service_manager", "file_service"],
        ...
        "vector_reader": {
            ...
            "category": "storage",
            "storage_type": "vector",
            "requires": ["logging_service", "storage_service_manager", "vector_service"],
    ...
    def get_agents_by_category(cls, category: str) -> Dict:
        ...
        """
        return {k: v for k, v in cls.AGENTS.items() 
