...
from agentmap.di import initialize_di, ApplicationContainer
...
class BaseHandler(ABC):
    ...
    def _handle_run_request(self, request_data: Dict[str, Any], context: Any = None) -> Dict[str, Any]:
        """Handle graph execution request."""
        try:
            # Get services
            graph_runner_service, _, logging_service = self.adapter.initialize_services()
            ...
            logger.info(f"Serverless executing graph: {run_options.graph_name or 'default'}")
    ...
    def _handle_validate_request(self, request_data: Dict[str, Any], context: Any = None) -> Dict[str, Any]:
    ...
    def _handle_compile_request(self, request_data: Dict[str, Any], context: Any = None) -> Dict[str, Any]:
    ...
    def _handle_info_request(self, request_data: Dict[str, Any], context: Any = None) -> Dict[str, Any]:
