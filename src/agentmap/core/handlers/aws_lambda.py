...
def get_lambda_handler(container: Optional[ApplicationContainer] = None) -> AWSLambdaHandler:
    """
...
def validate_graph_lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
