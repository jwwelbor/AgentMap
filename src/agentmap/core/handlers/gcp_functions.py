...
def get_gcp_handler(container: Optional[ApplicationContainer] = None) -> GCPFunctionHandler:
    """
...
def gcp_handler_with_config(config_file: str):
    ...
    return configured_http_handler, configured_pubsub_handler, configured_storage_handler
