...
class NodeFilter:
    @staticmethod
    def apply_node_filter(nodes: Dict[str, Dict[str, Any]], node_filter: str) -> Dict[str, Dict[str, Any]]:
        ...
        if "|" in node_filter:
            ...
            return {name: info for name, info in nodes.items() if info.get("type", "").lower() == type_filter.lower()}
        return nodes
