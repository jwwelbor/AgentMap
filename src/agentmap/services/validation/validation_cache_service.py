...
class ValidationCacheService:
    ...
    def _read_cache(self, file_path: Path, file_hash: str) -> Optional[ValidationResult]:
        ...
        try:
            ...
            if not isinstance(cache_data, dict) or 'cached_at' not in cache_data or 'result' not in cache_data:
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    self.logger.debug("Using model_dump() with manual datetime conversion")
                except Exception as e:
