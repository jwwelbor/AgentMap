...
class IndentedTemplateComposer:
    ...
    def compose_template(
        ...
        try:
            ...
            variables = (
                self._agent_variable_generator.prepare_comprehensive_template_variables(
    ...
    def _generate_services_documentation(
        ...
        """
        return self._agent_variable_generator.generate_services_documentation(
            attributes
        )
    ...
    def _generate_service_usage_examples(
        ...
        """
        return self._agent_variable_generator.generate_service_usage_examples(
            service_reqs
        )
