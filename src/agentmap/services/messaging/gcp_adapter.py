    ...
    def _initialize_client(self) -> None:
        ...
        try:
            ...
            try:
                ...
                self.logger.debug(f"GCP Pub/Sub client initialized for project: {self.project_id}")
    ...
    async def create_topic(self, topic_name: str) -> StorageResult:
        ...
        try:
            ...
            try:
                ...
                if "already exists" in error_msg or "resource already exists" in error_msg:
                    ...
                    self.logger.error(f"Failed to create GCP Pub/Sub topic {topic_name}: {str(e)}")
                    return StorageResult(
                        success=False,
