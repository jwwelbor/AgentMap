"""
Template loading and caching module for IndentedTemplateComposer.

Extracted from IndentedTemplateComposer to handle all template loading
and caching responsibilities, following the Single Responsibility Principle.
"""
...
class TemplateLoader:
    """
    Handles template loading from embedded resources and filesystem with caching.

    This class encapsulates all template loading logic that was previously
    in IndentedTemplateComposer, providing a clean separation of concerns.
    """
    ...
    def __init__(
        ...
        """
        Initialize template loader with required dependencies.
        ...
        self.logger.debug("[TemplateLoader] Initialized with caching support")
    ...
    def load_template(self, template_path: str) -> str:
        ...
        if normalized_path in self._template_cache:
            ...
            self.logger.trace(f"[TemplateLoader] Cache hit for template: {normalized_path}")
