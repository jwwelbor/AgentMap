...
from agentmap.services.dependency_validators import (
    DependencyValidator,
    ProviderValidator,
)
...
class DependencyCheckerService:
    ...
    def discover_and_validate_providers(
        ...
        if category_lower == "llm":
            ...
            for (
                storage_type
            ) in BuiltinDefinitionConstants.get_supported_storage_types():
    ...
    def get_installation_guide(self, provider: str, category: str = "llm") -> str:
        return self._installation_guide_helper.get_installation_guide(
            provider, category
        )
    ...
    def _get_storage_installation_guide(
        ...
        return self._installation_guide_helper.get_storage_installation_guide(
            storage_type
        )
