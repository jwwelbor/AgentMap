...
class AgentConfigService:
    ...
    _AGENT_TO_STORAGE_TYPE = property(lambda self: BuiltinDefinitionConstants.get_agent_to_storage_type())
    _LLM_AGENT_TO_PROVIDER = property(lambda self: BuiltinDefinitionConstants.get_llm_agent_to_provider())
