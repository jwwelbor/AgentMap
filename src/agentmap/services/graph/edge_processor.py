...
class EdgeProcessor:
    ...
    def __init__(self, logging_service: LoggingService, function_resolution_service: FunctionResolutionService, state_adapter_service: StateAdapterService):
        self.logger = logging_service.get_class_logger(self)
        self.function_resolution = function_resolution_service
        self.state_adapter = state_adapter_service

    def process_node_edges(self, builder: StateGraph, node_name: str, edges: Dict[str, Union[str, List[str]]], orchestrator_nodes: List[str]) -> None:
    ...
    def _try_add_function_edge(self, builder: StateGraph, node_name: str, edges: Dict[str, Union[str, List[str]]]) -> bool:
    ...
    def _normalize_edge_value(self, edge_value: Union[str, List[str], None]) -> Tuple[bool, Union[str, List[str], None]]:
    ...
    def _add_standard_edges(self, builder: StateGraph, node_name: str, edges: Dict[str, Union[str, List[str]]]) -> None:
        ...
        if has_success and has_failure:
            ...
            _, default_targets = self._normalize_edge_value(edges["default"])
            builder.add_edge(node_name, default_targets)

    def add_dynamic_router(self, builder: StateGraph, node_name: str, failure_target: Optional[str] = None) -> None:
