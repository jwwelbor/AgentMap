...
class Templates:
    def __init__(self, composer: IndentedTemplateComposer = None):
        self.composer = composer or IndentedTemplateComposer()

    def render_agent(self, agent_type: str, info: Dict[str, Any], service_reqs: ServiceRequirements) -> str:
