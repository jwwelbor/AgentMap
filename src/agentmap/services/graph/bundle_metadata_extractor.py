# services/graph/bundle_metadata_extractor.py
...
class BundleMetadataExtractor:
    """Handles extraction of critical metadata from graph bundles (Phase 1).

    This class is responsible for extracting and organizing core metadata needed
    for graph bundle creation, including service filtering, agent mappings, and
    ...
    def __init__(
        ...
        Args:
            ...
            agent_factory_service: Service for agent-related operations
        """
