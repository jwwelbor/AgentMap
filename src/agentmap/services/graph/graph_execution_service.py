...
class GraphExecutionService:
    ...
    def execute_compiled_graph(
        ...
        try:
            ...
            self.logger.debug(f"[GraphExecutionService] Starting graph invocation: {graph_name}")
            self.logger.debug(f"[GraphExecutionService] Initial state keys: {list(initial_state.keys())}")
