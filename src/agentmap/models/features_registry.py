...
class FeaturesRegistry:
    ...
    def set_provider_status(self, category: str, provider: str, available: bool, validated: bool) -> None:
        """
    ...
    def __repr__(self) -> str:
        ...
        provider_count = sum(len(providers) for providers in self.providers_available.values())
        return f"<FeaturesRegistry {feature_count} features, {provider_count} providers>"
