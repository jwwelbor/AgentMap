...
BUILTIN_AGENTS = [
    ...
    },
    {
        ...
        "Default_Context": json.dumps(
            {"interaction_type": "approval", "timeout_seconds": 3600}
        ),
        "Tool_Source": "",
        "Available_Tools": "",
    },
    ...
    },
    {
        ...
        "Default_Context": json.dumps(
            {"interaction_type": "text_input", "timeout_seconds": 3600}
        ),
        "Tool_Source": "",
        "Available_Tools": "",
    },
    {
        ...
        "Default_Context": json.dumps(
            {"interaction_type": "edit", "timeout_seconds": 3600}
        ),
        "Tool_Source": "",
        "Available_Tools": "",
    },
    {
        ...
        "Default_Prompt": "",
        "Default_Context": json.dumps({"subgraph_name": "SubWorkflowName"}),
        "Tool_Source": "",
        "Available_Tools": "",
    },
    # LLM Agents
    ...
    # Storage Agents
    {
        ...
        "Output_Field": "data",
        "Default_Prompt": "",
        "Default_Context": json.dumps({"encoding": "utf-8", "delimiter": ","}),
        "Tool_Source": "",
        "Available_Tools": "",
    },
    {
        ...
        "Default_Prompt": "",
        "Default_Context": json.dumps(
            {"encoding": "utf-8", "delimiter": ",", "mode": "write"}
        ),
        "Tool_Source": "",
        "Available_Tools": "",
    },
    {
        ...
        "Output_Field": "data",
        "Default_Prompt": "",
        "Default_Context": json.dumps({"encoding": "utf-8"}),
        "Tool_Source": "",
        "Available_Tools": "",
    },
    {
        ...
        "Output_Field": "status",
        "Default_Prompt": "",
        "Default_Context": json.dumps({"encoding": "utf-8", "indent": 2}),
        "Tool_Source": "",
        "Available_Tools": "",
    },
    {
    ...
    },
    {
        ...
        "Output_Field": "status",
        "Default_Prompt": "",
        "Default_Context": json.dumps({"encoding": "utf-8", "mode": "write"}),
        "Tool_Source": "",
        "Available_Tools": "",
    },
    {
        ...
        "Default_Prompt": "",
        "Default_Context": json.dumps({"collection": "default", "top_k": 5}),
        "Tool_Source": "",
        "Available_Tools": "",
    },
    {
        ...
        "Output_Field": "status",
        "Default_Prompt": "",
        "Default_Context": json.dumps({"collection": "default"}),
        "Tool_Source": "",
        "Available_Tools": "",
    },
    # Mixed/Special Agents
    {
        ...
        "Default_Context": json.dumps({"format": "markdown", "include_metrics": True}),
        "Tool_Source": "",
        "Available_Tools": "",
    },
    {
        ...
        "Default_Context": json.dumps({"selection_strategy": "llm_based"}),
        "Tool_Source": "",
        "Available_Tools": "",
    },
    {
        ...
        "Default_Context": json.dumps({"max_iterations": 5}),
...
def create_styles():
    ...
    styles["header"].fill = PatternFill(
        start_color="2E75B6", end_color="2E75B6", fill_type="solid"
    )
    styles["header"].alignment = Alignment(
    ...
    styles["subheader"].fill = PatternFill(
    ...
    styles["required"].fill = PatternFill(
...
def build_agent_definitions_sheet(wb, styles):
    ...
    ws["A2"] = (
        "Define your custom agents here. These will be available in the Workflow tab dropdown."
    )
    ...
    agent_type_validation = DataValidation(
        type="list", formula1='"' + ",".join(AGENT_TYPES) + '"', allow_blank=True
    )
    ...
    category_validation = DataValidation(
        type="list", formula1='"Core,LLM,Storage,Mixed,Custom"', allow_blank=True
    )
...
def build_prompts_sheet(wb, styles):
    ...
    ws["A2"] = (
        "Define reusable prompts here. Reference them in the Workflow tab using @Prompt_ID"
    )
    ws["A2"].font = Font(italic=True, size=10, color="666666")
    ws.row_dimensions[2].height = 20
...
def build_workflow_sheet(wb, styles):
    ...
    ws["A2"] = (
        "Define your workflow here. Select agents from dropdown or use builtin_* agents. The CSV_Export sheet will generate the final CSV."
    )
    ws["A2"].font = Font(italic=True, size=10, color="666666")
    ws.row_dimensions[2].height = 20
    ...
    agent_validation = DataValidation(
        type="list", formula1='INDIRECT("AgentList")', allow_blank=True  # Named range
    )
...
def build_builtin_agents_sheet(wb, styles):
    ...
    ws.merge_cells("A2:J2")
    ws["A2"] = (
        "Reference sheet for all builtin agents. These can be selected directly in the Workflow tab."
    )
    ws["A2"].font = Font(italic=True, size=10, color="666666")
    ws.row_dimensions[2].height = 20
...
def build_csv_export_sheet(wb, styles):
    ...
    ws["A2"] = (
        "This sheet shows the final CSV output. Copy all data (Ctrl+C) and paste into a text file, or use File > Save As > CSV."
    )
    ws["A2"].font = Font(italic=True, size=10, color="666666")
    ws.row_dimensions[2].height = 20
    ...
    for row in range(4, 200):
        ...
        ws.cell(
            row=row,
            column=1,
            value=f'=IF(Workflow!A{workflow_row}="","",Workflow!A{workflow_row})',
        )
        ...
        ws.cell(
            row=row,
            column=2,
            value=f'=IF(Workflow!B{workflow_row}="","",Workflow!B{workflow_row})',
        )
        ...
        ws.cell(
            row=row,
            column=3,
            value=f'=IF(Workflow!B{workflow_row}="","",IF(Workflow!D{workflow_row}<>"",Workflow!D{workflow_row},IFERROR(VLOOKUP(Workflow!C{workflow_row},Builtin_Agents!A:B,2,FALSE),IFERROR(VLOOKUP(Workflow!C{workflow_row},Agent_Definitions!A:B,2,FALSE),""))))',
        )
        ...
        ws.cell(
            row=row,
            column=4,
            value=f'=IF(Workflow!B{workflow_row}="","",IF(LEFT(Workflow!E{workflow_row},1)="@",IFERROR(VLOOKUP(MID(Workflow!E{workflow_row},2,100),Prompts!A:C,3,FALSE),Workflow!E{workflow_row}),Workflow!E{workflow_row}))',
        )
        ...
        ws.cell(
            row=row,
            column=5,
            value=f'=IF(Workflow!B{workflow_row}="","",Workflow!F{workflow_row})',
        )
        ...
        ws.cell(
            row=row,
            column=6,
            value=f'=IF(Workflow!B{workflow_row}="","",IF(Workflow!G{workflow_row}<>"",Workflow!G{workflow_row},IFERROR(VLOOKUP(Workflow!C{workflow_row},Builtin_Agents!A:H,8,FALSE),IFERROR(VLOOKUP(Workflow!C{workflow_row},Agent_Definitions!A:H,8,FALSE),""))))',
        )
        ...
        ws.cell(
            row=row,
            column=7,
            value=f'=IF(Workflow!B{workflow_row}="","",IF(Workflow!H{workflow_row}<>"",Workflow!H{workflow_row},IFERROR(VLOOKUP(Workflow!C{workflow_row},Builtin_Agents!A:E,5,FALSE),IFERROR(VLOOKUP(Workflow!C{workflow_row},Agent_Definitions!A:E,5,FALSE),""))))',
        )
        ...
        ws.cell(
            row=row,
            column=8,
            value=f'=IF(Workflow!B{workflow_row}="","",IF(Workflow!I{workflow_row}<>"",Workflow!I{workflow_row},IFERROR(VLOOKUP(Workflow!C{workflow_row},Builtin_Agents!A:F,6,FALSE),IFERROR(VLOOKUP(Workflow!C{workflow_row},Agent_Definitions!A:F,6,FALSE),""))))',
        )
        ...
        ws.cell(
            row=row,
            column=9,
            value=f'=IF(Workflow!B{workflow_row}="","",Workflow!J{workflow_row})',
        )
        ...
        ws.cell(
            row=row,
            column=10,
            value=f'=IF(Workflow!B{workflow_row}="","",Workflow!K{workflow_row})',
        )
        ...
        ws.cell(
            row=row,
            column=11,
            value=f'=IF(Workflow!B{workflow_row}="","",Workflow!L{workflow_row})',
        )
...
def build_help_sheet(wb, styles):
    ...
    help_content = [
        ...
        (
            "",
            "1. Agent_Definitions",
            "Define your custom agents with their configurations",
        ),
        ("", "2. Prompts", "Create reusable prompts that can be referenced anywhere"),
        (
            "",
            "3. Workflow",
            "Build your workflow by selecting agents and defining flow",
        ),
