...
def demo_default_configuration():
    ...
    mock_tracker = (
        MockServiceFactory.create_mock_execution_tracking_service().create_tracker()
    )
    ...
    agent = BranchingAgent(
        ...
        context={"input_fields": ["success"], "output_field": "result"},
        logger=logger,
...
def demo_custom_configuration():
    ...
    api_validator = BranchingAgent(
        ...
        context={
            "input_fields": [
                "http_status"
            ],  # This automatically becomes the success_field!
