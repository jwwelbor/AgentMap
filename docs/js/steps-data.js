...
const stepsData = [
    {
        ...
        description: "A comprehensive overview of how all parts work together with clean architecture.",
        details: "AgentMap uses a clean architecture with dependency injection, separating models (data containers) from services (business logic) to create flexible, testable workflows.",
        code: null,
        visual: `
