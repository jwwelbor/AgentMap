...
class TestGraphIdentifierParsing:
    ...
    def setup_method(self):
        ...
        self.app_config_service.get_csv_repository_path.return_value = (
            self.csv_repository
        )
    ...
    def test_service_error_handling(self):
        ...
        self.app_config_service.get_csv_repository_path.side_effect = Exception(
            "Service error"
        )
