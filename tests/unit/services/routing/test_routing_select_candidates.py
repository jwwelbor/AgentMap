...
from agentmap.services.routing.routing_service import LLMRoutingService, ActivityRoutingTable
...
class DummyCfg:
    ...
    def is_routing_cache_enabled(self): return False
    def get_cache_ttl(self): return 300
    def get_model_for_complexity(self, provider, tier): return self.routing_matrix.get(provider,{}).get(tier)
    def get_fallback_provider(self): return "anthropic"
    def get_fallback_model(self): return "claude-3-5-sonnet"
    def get_provider_preference(self): return ["anthropic","openai"]
...
def make_router():
    ...
    # fake analyzer
    class An:
        def analyze_prompt_complexity(self, *_a, **_k): return TaskComplexity.MEDIUM
