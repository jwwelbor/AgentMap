...
class MockStorageServiceManager:
    ...
    def __init__(self, available_services: Optional[List[str]] = None):
        self.available_services = (
            ...
            else ["csv", "json", "file", "vector", "memory"]
        )
        self.services = {
...
class TestAgentServiceInjectionService(unittest.TestCase):
    ...
    def test_llm_protocol_injection(self):
        ...
        self.assertEqual(
            agent.llm_service, self.llm_service, "Should be the correct service"
        )
    ...
    def test_storage_protocol_injection(self):
        ...
        self.assertIsNotNone(
            agent.storage_service, "Storage service should be configured"
        )
        self.assertEqual(
            agent.storage_service,
            self.storage_service_manager,
            "Should be the correct service",
        )
    ...
    def test_vector_protocol_injection(self):
        ...
        self.assertEqual(configured, 1, "Should configure 1 service")
        self.assertIsNotNone(
            agent.vector_service, "Vector service should be configured"
        )
    ...
    def test_memory_protocol_injection(self):
        ...
        self.assertEqual(configured, 1, "Should configure 1 service")
        self.assertIsNotNone(
            agent.memory_service, "Memory service should be configured"
        )
    ...
    def test_prompt_protocol_injection(self):
        ...
        self.assertEqual(configured, 1, "Should configure 1 service")
        self.assertIsNotNone(
            agent.prompt_manager_service, "Prompt service should be configured"
        )
    ...
    def test_orchestration_protocol_injection(self):
        ...
        self.assertEqual(configured, 1, "Should configure 1 service")
        self.assertIsNotNone(
            agent.orchestrator_service, "Orchestration service should be configured"
        )
    ...
    def test_blob_storage_protocol_injection(self):
        ...
        self.assertEqual(configured, 1, "Should configure 1 service")
        self.assertIsNotNone(
            agent.blob_storage_service, "Blob storage service should be configured"
        )
    ...
    def test_missing_optional_prompt_service(self):
        ...
        self.assertIsNone(
            agent.prompt_manager_service, "Service should not be configured"
        )
    ...
    def test_missing_optional_orchestration_service(self):
        ...
        self.assertIsNone(
            agent.orchestrator_service, "Service should not be configured"
        )
    ...
    def test_missing_optional_blob_storage_service(self):
        ...
        self.assertIsNone(
            agent.blob_storage_service, "Service should not be configured"
        )
    ...
    def test_requires_storage_services(self):
        ...
        self.assertTrue(
            self.injection_service.requires_storage_services(multi_storage_agent)
        )
    ...
    def test_get_required_service_types(self):
        ...
        multi_types = self.injection_service.get_required_service_types(
            multi_storage_agent
        )
    ...
    def test_storage_capable_agent_fallback(self):
        ...
        storage_configured = self.injection_service.configure_storage_services(agent)
        self.assertEqual(
            storage_configured, 1, "Should configure 1 service via fallback"
        )
        self.assertIsNotNone(
            agent.storage_service, "Storage service should be configured"
        )
    ...
    def test_configure_execution_tracker_no_method(self):
        ...
        self.assertFalse(
            configured, "Should not configure tracker on unsupported agent"
        )
