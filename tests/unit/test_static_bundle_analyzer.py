...
class TestStaticBundleAnalyzer(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(self.analyzer.custom_agent_declaration_manager, self.mock_custom_agent_declaration_manager)
    ...
    def test_create_static_bundle_no_implementation_loading(self, mock_exists):
        ...
        with patch('builtins.__import__') as mock_import:
            ...
            agent_imports = [call for call in mock_import.call_args_list 
                           if call[0] and len(call[0]) > 0 
                           and 'agentmap.agents' in str(call[0][0])]
            self.assertEqual(len(agent_imports), 0, 
    ...
    def test_resolve_requirements_with_dependencies(self, mock_exists):
        ...
        self.mock_declaration_registry.get_protcol_service_map.return_value = {"LLMServiceProtocol": "llm_service"}
    ...
    def test_validate_declarations(self):
        ...
        self.mock_custom_agent_declaration_manager.get_agent_declaration.return_value = None
