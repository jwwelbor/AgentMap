...
class TestRuntimeManager(unittest.TestCase):
    ...
    def test_thread_safety_concurrent_initialization(self):
        ...
        with patch('agentmap.runtime.runtime_manager.initialize_di') as mock_initialize_di:
            mock_container = MagicMock()
            mock_initialize_di.return_value = mock_container
            ...
            with ThreadPoolExecutor(max_workers=num_threads) as executor:
                futures = [executor.submit(initialize_worker) for _ in range(num_threads)]
        ...
        with patch('agentmap.runtime.runtime_manager.initialize_di') as mock_initialize_di:
            ...
            if exceptions:
                ...
                unexpected_exceptions = [
                    ...
                    if not isinstance(e, AgentMapNotInitialized)
                ]
                self.assertEqual(len(unexpected_exceptions), 0, 
