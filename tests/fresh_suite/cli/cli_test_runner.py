...
def run_tests(test_pattern=None):
    ...
    if test_pattern:
        ...
        if test_pattern == "validation":
            suite = loader.loadTestsFromName('test_validation_commands', start_dir=test_dir)
        elif test_pattern == "workflow":
            suite = loader.loadTestsFromName('test_main_workflow_commands', start_dir=test_dir)
        elif test_pattern == "diagnostic":
            suite = loader.loadTestsFromName('test_diagnostic_commands', start_dir=test_dir)
