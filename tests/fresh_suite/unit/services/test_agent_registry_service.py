...
class TestAgentRegistryService(unittest.TestCase):
    ...
    def test_service_initialization(self):
        ...
        self.assertTrue(any(call[1] == "[AgentRegistryService] Initialized" 
    ...
    def test_register_agent_adds_to_registry(self):
        ...
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Registered agent 'custom': CustomAgent" in call[1] 
                          for call in logger_calls if call[0] == "debug"))
    ...
    def test_register_agent_default_agent(self):
        ...
        self.assertEqual(self.agent_registry_model.default_agent_class, self.mock_default_agent)
        
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Registered default agent: DefaultAgent" in call[1] 
                          for call in logger_calls if call[0] == "debug"))
    ...
    def test_register_agent_case_normalization(self):
        ...
        self.assertTrue(self.agent_registry_model.has_agent("CUSTOM_TYPE"))  # Should find it
    ...
    def test_unregister_agent_removes_from_registry(self):
        ...
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Unregistered agent: test_agent" in call[1] 
                          for call in logger_calls if call[0] == "debug"))
    ...
    def test_unregister_agent_nonexistent_logs_warning(self):
        ...
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Attempted to unregister unknown agent: nonexistent_agent" in call[1] 
    ...
    def test_get_agent_class_returns_registered_agent(self):
        ...
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Retrieved agent 'test_agent': CustomAgent" in call[1] 
                          for call in logger_calls if call[0] == "debug"))
    ...
    def test_get_agent_class_returns_default_for_empty_type(self):
        ...
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Retrieved default agent: DefaultAgent" in call[1] 
                          for call in logger_calls if call[0] == "debug"))
    ...
    def test_get_agent_class_returns_provided_default_when_not_found(self):
        ...
        # Act
        result = self.service.get_agent_class("nonexistent_agent", self.mock_default_agent)
        ...
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Agent 'nonexistent_agent' not found, using default: DefaultAgent" in call[1] 
                          for call in logger_calls if call[0] == "debug"))
    ...
    def test_get_agent_class_returns_none_when_not_found_no_default(self):
        ...
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Agent 'nonexistent_agent' not found, no default provided" in call[1] 
                          for call in logger_calls if call[0] == "debug"))
    ...
    def test_list_agents_returns_all_registered_agents(self):
        ...
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Listed 3 registered agents" in call[1] 
                          for call in logger_calls if call[0] == "debug"))
    ...
    def test_list_agents_empty_registry(self):
        ...
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Listed 0 registered agents" in call[1] 
                          for call in logger_calls if call[0] == "debug"))
    ...
    def test_get_default_agent_class_returns_default_when_set(self):
        ...
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Retrieved default agent class: DefaultAgent" in call[1] 
                          for call in logger_calls if call[0] == "debug"))
    ...
    def test_get_default_agent_class_returns_none_when_not_set(self):
        ...
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("No default agent class is set" in call[1] 
                          for call in logger_calls if call[0] == "debug"))
    ...
    def test_set_default_agent_class_registers_as_default(self):
        ...
        self.assertTrue(self.agent_registry_model.has_agent("default"))
        self.assertEqual(self.agent_registry_model.default_agent_class, self.mock_default_agent)
        self.assertEqual(self.service.get_default_agent_class(), self.mock_default_agent)
        
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Set default agent class: DefaultAgent" in call[1] 
                          for call in logger_calls if call[0] == "debug"))
    ...
    def test_get_registered_agent_types_returns_all_type_names(self):
        ...
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Found 3 registered agent types:" in call[1] 
                          for call in logger_calls if call[0] == "debug"))
    ...
    def test_get_registered_agent_types_empty_registry(self):
        ...
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Found 0 registered agent types:" in call[1] 
                          for call in logger_calls if call[0] == "debug"))
    ...
    def test_clear_all_agents_removes_all_registrations(self):
        ...
        # Verify warning logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Cleared all 3 registered agents" in call[1] 
                          for call in logger_calls if call[0] == "warning"))
    ...
    def test_clear_all_agents_empty_registry(self):
        ...
        # Verify logging
        logger_calls = self.mock_logger.calls
        self.assertTrue(any("Cleared all 0 registered agents" in call[1] 
                          for call in logger_calls if call[0] == "warning"))
    ...
    def test_model_case_normalization_consistency(self):
        ...
        self.assertTrue(self.agent_registry_model.has_agent("CamelCase"))  # Model normalizes input
        self.assertTrue(self.agent_registry_model.has_agent("CAMELCASE"))
    ...
    def test_service_handles_special_characters_in_agent_type(self):
        ...
        special_types = ["agent-with-dashes", "agent_with_underscores", "agent.with.dots"]
