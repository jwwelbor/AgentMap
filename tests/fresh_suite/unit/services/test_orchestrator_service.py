...
class TestOrchestratorService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_prompt_manager_service.format_prompt.return_value = "Formatted orchestration prompt"
        ...
        self.mock_logger = self.mock_logging_service.get_class_logger(OrchestratorService)
    
    def create_orchestrator_service(self, include_llm=True, include_features_registry=True, nlp_capabilities=None):
        ...
        if include_features_registry:
            ...
            default_capabilities = nlp_capabilities or {
                ...
                "supported_features": ["fuzzy_string_matching", "advanced_tokenization"]
            }
            mock_features_registry.get_nlp_capabilities.return_value = default_capabilities
            mock_features_registry.has_fuzzywuzzy.return_value = default_capabilities["fuzzywuzzy_available"]
            mock_features_registry.has_spacy.return_value = default_capabilities["spacy_available"]
    ...
    def test_fuzzy_keyword_match_with_available_library(self):
        ...
        score, matches = service._fuzzy_keyword_match("user authentication required", keywords)
        # Should return valid types regardless of library availability
        self.assertIsInstance(score, float)
        self.assertIsInstance(matches, list)
        self.assertGreaterEqual(score, 0.0)  # Should be >= 0, may be 0 if library not available
        ...
        score2, matches2 = service._fuzzy_keyword_match("authentcation needed", keywords, threshold=70)
    ...
    def test_enhanced_algorithm_match_with_nlp_fallback(self):
        ...
        node2, confidence2 = service._algorithm_match("authentication required", test_nodes)
    ...
    def test_basic_keyword_match_level2(self):
        ...
        node, confidence = service._basic_keyword_match("user authentication needed", test_nodes)
        self.assertEqual(node, "auth_node")
        self.assertGreater(confidence, 0.0)
        
        # Should match payment_node for payment keywords
        node2, confidence2 = service._basic_keyword_match("process billing transaction", test_nodes)
    ...
    def test_fuzzy_algorithm_match_level3(self):
        ...
        node, confidence = service._fuzzy_algorithm_match("authentcation needed", test_nodes)
    ...
    def test_spacy_algorithm_match_level4(self):
        ...
        node, confidence = service._spacy_algorithm_match("verify user identity", test_nodes)
    ...
    def test_nlp_graceful_degradation_in_algorithm_match(self):
        ...
        node, confidence = service._algorithm_match("authentication required", self.test_nodes)
    ...
    def test_algorithm_match_handles_invalid_nodes(self):
        ...
        invalid_nodes = {
            "valid_node": {"description": "Valid node", "context": {"keywords": "valid"}},
    ...
    def test_get_service_info(self):
        ...
        self.assertEqual(info["template_file"], "file:orchestrator/intent_matching_v1.txt")
        ...
        self.assertIn("Level 4: spaCy enhanced matching (if spaCy available)", info["matching_levels"])
