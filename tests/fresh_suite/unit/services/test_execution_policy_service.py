...
class TestExecutionPolicyService(unittest.TestCase):
    ...
    def test_service_initialization(self):
        ...
        self.assertTrue(
            any(
                call[1] == "[ExecutionPolicyService] Initialized"
    ...
    def test_service_logs_status(self):
        ...
        self.assertTrue(
            any(
                "[ExecutionPolicyService] Initialized" in call[1] for call in info_calls
            )
        )
    ...
    def test_evaluate_success_policy_all_nodes_success(self):
        ...
        self.assertTrue(
            any("Evaluating success policy" in call[1] for call in debug_calls)
        )
        self.assertTrue(
            any(
                "Policy evaluation complete" in call[1] and "Result: True" in call[1]
    ...
    def test_evaluate_success_policy_critical_nodes_success(self):
        ...
        self.configure_execution_config(
            {"type": "critical_nodes", "critical_nodes": ["node1", "node3"]}
        )
    ...
    def test_evaluate_success_policy_critical_nodes_missing_node(self):
        ...
        self.configure_execution_config(
            {"type": "critical_nodes", "critical_nodes": ["node1", "missing_node"]}
        )
    ...
    def test_evaluate_success_policy_custom_success(self):
        ...
        self.configure_execution_config(
            {"type": "custom", "custom_function": "test.module.custom_policy_success"}
        )
    ...
    def test_evaluate_success_policy_custom_failure(self):
        ...
        # Configure policy with custom function
        self.configure_execution_config(
            {"type": "custom", "custom_function": "test.module.custom_policy_failure"}
        )
    ...
    def test_evaluate_success_policy_custom_missing_function(self):
        ...
        self.assertTrue(
            any(
                "Custom policy selected but no function specified" in call[1]
    ...
    def test_evaluate_success_policy_unknown_type_fallback(self):
        ...
        self.configure_execution_config({"type": "unknown_policy_type"})
        ...
        self.assertTrue(
            any(
                "Unknown success policy type: unknown_policy_type" in call[1]
                for call in warning_calls
            )
        )
    ...
    def test_evaluate_success_policy_configuration_access_error(self):
        ...
        self.mock_app_config_service.get_execution_config.side_effect = Exception(
            "Config error"
        )
        ...
        self.assertTrue(
            any("Error evaluating policy" in call[1] for call in error_calls)
        )
    ...
    def test_validate_policy_config_critical_nodes_not_list(self):
        ...
        policy_config = {"type": "critical_nodes", "critical_nodes": "not_a_list"}
    ...
    def test_validate_policy_config_critical_nodes_empty(self):
        ...
        policy_config = {"type": "critical_nodes", "critical_nodes": []}

        errors = self.service.validate_policy_config(policy_config)

        self.assertEqual(len(errors), 1)
        self.assertIn(
            "critical_nodes policy requires at least one critical node", errors[0]
        )
    ...
    def test_validate_policy_config_custom_missing_function(self):
        ...
        self.assertEqual(len(errors), 1)
        self.assertIn(
            "custom policy requires custom_function to be specified", errors[0]
        )
    ...
    def test_validate_policy_config_custom_function_not_string(self):
        ...
        policy_config = {"type": "custom", "custom_function": 123}  # Not a string
    ...
    def test_validate_policy_config_custom_function_invalid_format(self):
        ...
        self.assertEqual(len(errors), 1)
        self.assertIn(
            "custom_function must be in format 'module.path.function_name'", errors[0]
        )
    ...
    def test_validate_policy_config_multiple_errors(self):
        ...
        self.assertTrue(
            any("critical_nodes must be a list" in error for error in errors)
        )
    ...
    def test_get_policy_description_all_policies(self):
        ...
        for policy_type, description in descriptions.items():
            ...
            self.assertIn(
                policy_type.replace("_", " "), description.lower()
            )  # Should mention policy type
    ...
    def test_get_service_info(self):
        ...
        self.assertEqual(
            info["available_policies"],
            ["all_nodes", "final_node", "critical_nodes", "custom"],
        )
    ...
    def test_get_service_info_config_error(self):
        ...
        self.assertIn(
            "Unable to load policy configuration", info["current_policy"]["error"]
        )
    ...
    def test_evaluate_custom_policy_import_error(self):
        ...
        # Configure policy with custom function
        self.configure_execution_config(
            {"type": "custom", "custom_function": "nonexistent.module.function"}
        )
        ...
        self.assertTrue(
            any(
                "Error loading custom policy function" in call[1]
    ...
    def test_evaluate_custom_policy_attribute_error(self):
        ...
        # Configure policy with custom function
        self.configure_execution_config(
            {"type": "custom", "custom_function": "test.module.nonexistent_function"}
        )
    ...
    def test_evaluate_custom_policy_execution_error(self):
        ...
        # Configure policy with custom function
        self.configure_execution_config(
            {"type": "custom", "custom_function": "test.module.failing_function"}
        )
        ...
        mock_module = Mock()
        mock_failing_function = Mock(
            side_effect=RuntimeError("Function execution failed")
        )
        ...
        self.assertTrue(
            any(
                "Error executing custom policy function" in call[1]
                for call in error_calls
            )
        )
    ...
    def test_service_initialization_with_missing_dependencies(self):
        ...
        with self.assertRaises(AttributeError):
            ExecutionPolicyService(
                app_config_service=self.mock_app_config_service, logging_service=None
            )
        ...
        service_with_none_config = ExecutionPolicyService(
            app_config_service=None, logging_service=self.mock_logging_service
        )
