...
from agentmap.services.routing.types import (
    TaskComplexity, TaskType, RoutingContext, RoutingDecision, ComplexitySignal,
    normalize_task_type, normalize_complexity, get_complexity_order,
    get_valid_task_types, get_valid_complexity_levels
)
...
class TestTaskComplexity(unittest.TestCase):
    ...
    def test_task_complexity_from_string_valid(self):
        ...
        self.assertEqual(TaskComplexity.from_string("critical"), TaskComplexity.CRITICAL)
...
class TestTaskType(unittest.TestCase):
    ...
    def test_task_type_from_string_valid(self):
        ...
        self.assertEqual(TaskType.from_string("creative_writing"), TaskType.CREATIVE_WRITING)
...
class TestRoutingContext(unittest.TestCase):
    ...
    def test_routing_context_to_dict(self):
        ...
        expected_keys = {
            ...
            'fallback_provider', 'fallback_model', 'retry_with_lower_complexity'
        }
    ...
    def test_routing_context_roundtrip_serialization(self):
        ...
        self.assertEqual(original.complexity_override, reconstructed.complexity_override)
        self.assertEqual(original.provider_preference, reconstructed.provider_preference)
...
class TestUtilityFunctions(unittest.TestCase):
    ...
    def test_get_complexity_order(self):
        ...
        expected = [TaskComplexity.LOW, TaskComplexity.MEDIUM, TaskComplexity.HIGH, TaskComplexity.CRITICAL]
    ...
    def test_get_valid_task_types(self):
        ...
        expected_types = [
            "general", "analysis", "creative", "dialogue", "technical",
            "customer_service", "data_analysis", "creative_writing", "code_analysis"
        ]
