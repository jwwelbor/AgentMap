...
class TestLLMRoutingService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_routing_config.get_provider_preference.return_value = [
            "openai",
            "anthropic",
        ]
        ...
        self.mock_routing_config.get_fallback_model.return_value = (
        ...
        self.mock_complexity_analyzer.determine_overall_complexity.return_value = (
    ...
    def test_service_initialization_with_cache(self):
        ...
        self.assertEqual(
            self.service.complexity_analyzer, self.mock_complexity_analyzer
        )
        self.assertEqual(self.service.cache, self.mock_cache)
        self.assertIsNotNone(self.service._logger)

        # Verify cache was configured
        self.mock_cache.update_cache_parameters.assert_called_once_with(
    ...
    def test_route_request_success_without_cache(self):
        ...
        routing_context = RoutingContext(
            task_type=task_type, auto_detect_complexity=True, cost_optimization=True
        )
        ...
        with (
            patch.object(self.service, "select_candidates", return_value=[]),
    ...
    def test_route_request_error_handling(self):
        ...
        self.mock_complexity_analyzer.determine_overall_complexity.side_effect = (
    ...
    def test_determine_complexity_with_override(self):
        ...
        task_type = "general"
        routing_context = RoutingContext(
            task_type=task_type, complexity_override="critical"
        )
    ...
    def test_select_optimal_model_success(self):
        ...
        available_providers = ["openai", "anthropic"]
        routing_context = RoutingContext(
            task_type=task_type, provider_preference=["anthropic", "openai"]
        )
    ...
    def test_select_optimal_model_with_model_override(self):
        ...
        complexity = TaskComplexity.MEDIUM
        available_providers = ["openai", "anthropic"]
        routing_context = RoutingContext(task_type=task_type, model_override="gpt-4")
    ...
    def test_select_optimal_model_cost_optimization(self):
        ...
        available_providers = ["openai", "anthropic"]
        routing_context = RoutingContext(
            task_type=task_type, cost_optimization=True, max_cost_tier="medium"
        )
