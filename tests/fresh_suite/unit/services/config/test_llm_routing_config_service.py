...
from src.agentmap.services.config.llm_routing_config_service import LLMRoutingConfigService
...
class TestLlmRoutingConfigService(unittest.TestCase):
    ...
    def test_get_model_for_complexity(self):
        ...
        result = self.llm_routing_service.get_model_for_complexity('anthropic', 'medium')
        self.assertEqual(result, 'claude-3-sonnet-20240229')
        ...
        result = self.llm_routing_service.get_model_for_complexity('anthropic', 'unknown')
        self.assertIsNone(result)
    ...
    def test_is_provider_available(self):
        ...
        self.assertTrue(self.llm_routing_service.is_provider_available('ANTHROPIC'))  # Case insensitive
    ...
    def test_validate_config_missing_complexity_levels(self):
        ...
        errors = service.validate_AppConfigService()
        self.assertGreater(len(errors), 0)
        self.assertTrue(any('missing model for complexity' in error for error in errors))
    ...
    def test_validate_config_invalid_complexity_level(self):
        ...
        self.routing_config['routing_matrix'] = {
            'anthropic': {
                'invalid_level': 'claude-3-haiku-20240307'
            }
        }
        self.mock_app_config_service.get_routing_config.return_value = self.routing_config
    ...
    def test_validate_config_unknown_provider_reference(self):
        ...
        self.routing_config['task_types']['general']['provider_preference'] = ['unknown_provider']
        self.mock_app_config_service.get_routing_config.return_value = self.routing_config
    ...
    def test_validate_config_missing_prompt_thresholds(self):
        ...
        errors = service.validate_AppConfigService()
        self.assertGreater(len(errors), 0)
        self.assertTrue(any('Missing prompt length threshold' in error for error in errors))
    ...
    def test_routing_matrix_normalization(self):
        ...
        self.mock_app_config_service.get_routing_config.return_value = config_with_mixed_case
