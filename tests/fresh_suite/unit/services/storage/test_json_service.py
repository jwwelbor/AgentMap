...
class TestJSONStorageService(unittest.TestCase):
    ...
    def test_health_check_with_inaccessible_directory(self):
        ...
        with patch(
            "agentmap.services.storage.json_service.os.makedirs",
        ...
        with patch(
            "agentmap.services.storage.json_service.os.access", return_value=False
        ):  # Simulate no write access
    ...
    def test_update_path_operations(self):
        ...
        result = self.service._update_path(
            initial_data, "user.profile.bio", "Developer"
        )
    ...
    def test_find_document_by_id(self):
        ...
        dict_data = {"doc1": {"name": "Document 1"}, "doc2": {"name": "Document 2"}}
    ...
    def test_write_modes(self):
        ...
        result = self.service.write(
            collection, initial_data, document_id, WriteMode.WRITE
        )
        self.assertTrue(result.success)
        ...
        result = self.service.write(
            collection, update_data, document_id, WriteMode.UPDATE
        )
        self.assertTrue(result.success)
    ...
    def test_write_with_path(self):
        ...
        # Update using path
        result = self.service.write(
            collection, "Jane", document_id, WriteMode.UPDATE, path="user.name"
        )
        self.assertTrue(result.success)
        ...
        result = self.service.write(
            collection, 30, document_id, WriteMode.UPDATE, path="user.profile.age"
        )
        self.assertTrue(result.success)
    ...
    def test_delete_document(self):
        ...
        docs = {"doc1": {"title": "Document 1"}, "doc2": {"title": "Document 2"}}
    ...
    def test_read_with_query(self):
        ...
        result = self.service.read(
            collection, query={"author": "John", "published": True}
        )
        ...
        # Query with sorting
        result = self.service.read(
            collection, query={"published": True, "sort": "author"}
        )
    ...
    def test_update_nonexistent_document(self):
        ...
        result = self.service.write(
            collection, {"data": "new"}, "doc1", WriteMode.UPDATE
        )
    ...
    def test_large_nested_structures(self):
        ...
        deep_value = self.service.read(
            collection, document_id, path="nested.nested.nested.nested.data"
        )
    ...
    def test_mixed_data_types_in_collections(self):
        ...
        for doc_id, expected_data in documents:
            ...
            self.assertEqual(
                retrieved, expected_data, f"Data should match for {doc_id}"
            )
