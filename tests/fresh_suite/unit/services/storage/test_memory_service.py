...
from agentmap.services.storage.types import StorageConfig, StorageResult, WriteMode
...
class TestMemoryStorageService(unittest.TestCase):
    ...
    def test_write_modes(self):
        ...
        result = self.service.write(
            collection, more_items, "list_doc", WriteMode.APPEND
        )
        self.assertTrue(result.success)
    ...
    def test_path_based_operations(self):
        ...
        theme = self.service.read(
            collection, doc_id, path="user.profile.settings.theme"
        )
        ...
        # Verify path update
        updated_theme = self.service.read(
            collection, doc_id, path="user.profile.settings.theme"
        )
    ...
    def test_invalid_write_mode(self):
        ...
        with patch("agentmap.services.storage.memory_service.WriteMode") as mock_mode:
            ...
            try:
                result = self.service.write(
                    "test", {"data": "test"}, "doc1", mock_mode.INVALID
                )
    ...
    def test_update_nonexistent_document(self):
        ...
        result = self.service.write(
            "test", {"data": "new"}, "nonexistent", WriteMode.UPDATE
        )
    ...
    def test_persistence_file_operations(self):
        ...
        try:
            ...
            mock_persistent_storage_config = (
                MockServiceFactory.create_mock_storage_config_service(
                    memory_config_override
                )
            )
    ...
    def test_array_index_operations(self):
        ...
        data = {
            ...
            "nested": [{"id": 0, "value": "zero"}, {"id": 1, "value": "one"}],
        }
        ...
        self.service.write(
            collection, "updated_item", doc_id, WriteMode.WRITE, path="items.1"
        )
    ...
    def test_concurrent_access_simulation(self):
        ...
        initial_result = self.service.write(
            collection, {"counter": 0}, "shared_doc", WriteMode.WRITE
        )
        ...
        for i in range(1, 10):  # Start from 1 since we already created with 0
            result = self.service.write(
                collection, {"counter": i}, "shared_doc", WriteMode.UPDATE
            )
