...
class TestAgentFactoryService(unittest.TestCase):
    ...
    def test_import_class_from_path_success_agentmap_package(self):
        ...
        with patch('importlib.import_module') as mock_import_module:
            ...
            # Act
            result = self.service._resolver._import_class_from_path("agentmap.agents.builtins.default_agent.DefaultAgent")
            ...
            # Verify caching
            self.assertIn("agentmap.agents.builtins.default_agent.DefaultAgent", self.service.get_class_cache())
    ...
    def test_import_class_from_path_tries_custom_loader_for_non_package(self):
        ...
        # Act
        result = self.service._resolver._import_class_from_path("custom.path.CustomAgent")
    ...
    def test_get_agent_resolution_context_success(self, mock_resolve):
        ...
        self.assertEqual(context["_resolution_method"], "AgentClassResolver.resolve_agent_class")
