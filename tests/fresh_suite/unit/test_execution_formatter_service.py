...
class TestExecutionFormatterService(unittest.TestCase):
    ...
    def test_basic_formatting(self):
        ...
        output = self.formatter_service.format_execution_result(self.test_result, verbose=False)
    ...
    def test_verbose_formatting(self):
        ...
        output = self.formatter_service.format_execution_result(self.test_result, verbose=True)
    ...
    def test_special_output_formatting(self):
        ...
        output = self.formatter_service.format_execution_result(special_result, verbose=True)
