...
def test_protocol_injection():
    ...
    assert isinstance(agent, OrchestrationCapableAgent), "Agent should implement OrchestrationCapableAgent"
    ...
    assert agent.orchestrator_service == orchestrator_service, "Service should be the same instance"
