...
class TestModernizedFileReaderAgent(unittest.TestCase):
    ...
    def test_permission_error_handling(self):
        ...
        self.assertIsInstance(result, DocumentResult)
        self.assertFalse(result.success)
        self.assertIn("File not found", result.error)  # FileReaderAgent maps permission to file not found
    ...
    def test_logging_integration(self):
        ...
        read_logged = any("Starting read operation on file" in msg for msg in logged_messages)
        self.assertTrue(read_logged, f"Expected read operation logged, got: {logged_messages}")
