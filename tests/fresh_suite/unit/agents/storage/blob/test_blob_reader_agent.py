...
class TestBlobReaderAgent(unittest.TestCase):
    ...
    def test_process_with_file_not_found_error(self):
        ...
        self.mock_blob_storage_service.read_blob.side_effect = FileNotFoundError(
            "Blob not found"
        )
    ...
    def test_process_with_storage_operation_error(self):
        ...
        self.mock_blob_storage_service.read_blob.side_effect = StorageOperationError(
            "Storage failed"
        )
    ...
    def test_process_with_general_exception(self):
        ...
        self.mock_blob_storage_service.read_blob.side_effect = Exception(
            "Unexpected error"
        )
