...
class TestBlobWriterAgent(unittest.TestCase):
    ...
    def test_extract_data_with_data_key(self):
        ...
        call_args = self.mock_blob_storage_service.write_blob.call_args
        self.assertEqual(call_args[0][1], expected_bytes)  # Second argument should be data
    ...
    def test_blob_write_with_large_data(self):
        ...
        expected_result = {"success": True, "uri": test_uri, "size": len(expected_bytes)}
    ...
    def test_blob_write_storage_operation_error(self):
        ...
        self.mock_blob_storage_service.write_blob.side_effect = StorageOperationError("Write failed")
    ...
    def test_blob_write_general_exception(self):
        ...
        self.mock_blob_storage_service.write_blob.side_effect = Exception("Unexpected error")
    ...
    def test_integration_with_state_adapter_service(self):
        ...
        self.assertEqual(agent_with_state.state_adapter_service, self.mock_state_adapter_service)
