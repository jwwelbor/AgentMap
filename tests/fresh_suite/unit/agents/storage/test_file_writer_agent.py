...
class TestModernizedFileWriterAgent(unittest.TestCase):
        ...
        with patch.object(agent, 'get_collection', return_value='test.txt'):
            ...
            for mode in ["write", "append", "update"]:
                with self.subTest(mode=mode):
                    ...
                    self.assertIn("Missing required 'data' parameter", str(cm.exception))
    ...
    def test_logging_operation_start(self):
        ...
        self.assertTrue(write_logged, f"Expected write operation logged, got: {logged_messages}")
    ...
    def test_logging_default_mode(self):
        ...
        self.assertTrue(write_logged, f"Expected default write mode logged, got: {logged_messages}")
