...
class TestModernizedVectorReaderAgent(unittest.TestCase):
    ...
    def test_logging_integration(self):
        ...
        search_logged = any("Starting vector search with query" in msg for msg in logged_messages)
        self.assertTrue(search_logged, f"Expected vector search logged, got: {logged_messages}")
        
        # Verify query preview truncation for long queries
        truncated_logged = any("artificial intelligence and ma..." in msg for msg in logged_messages)
    ...
    def test_input_fields_configuration(self):
        ...
        collection = "docs"
        inputs = {"search_text": "custom field query"}  # Using first field from custom input_fields
