...
class TestBaseAgent(unittest.TestCase):
    ...
    def test_base_agent_initialization_with_all_infrastructure_services(self):
        ...
        self.assertEqual(
            agent.execution_tracking_service, self.mock_execution_tracking_service
        )
    ...
    def test_base_agent_initialization_with_minimal_parameters(self):
        ...
        agent = ConcreteAgent(name="minimal_agent", prompt="Minimal prompt")
    ...
    def test_base_agent_context_processing(self):
        ...
        agent = ConcreteAgent(
            name="context_test", prompt="Context test", context=context
        )
    ...
    def test_service_configuration_with_logging(self):
        ...
        storage_logged = any(
            "Storage service configured" in call[1] for call in debug_calls
        )

        self.assertTrue(llm_logged, f"Expected LLM service log, got: {debug_calls}")
        self.assertTrue(
            storage_logged, f"Expected storage service log, got: {debug_calls}"
        )
    ...
    def test_logger_property_access(self):
        ...
        agent_with_logger = ConcreteAgent(
            name="with_logger", prompt="Test", logger=self.mock_logger
        )
    ...
    def test_execution_tracker_property_access(self):
        ...
        self.assertEqual(
            agent_with_tracker.execution_tracking_service,
            self.mock_execution_tracking_service,
        )
    ...
    def test_state_adapter_property_access(self):
        ...
        self.assertEqual(
            agent_with_adapter.state_adapter_service, self.mock_state_adapter_service
        )
    ...
    def test_logging_methods(self):
        ...
        agent = ConcreteAgent(
            name="logging_test", prompt="Test", logger=self.mock_logger
        )
    ...
    def test_generic_log_method(self):
        ...
        agent = ConcreteAgent(
            name="generic_log_test", prompt="Test", logger=self.mock_logger
        )
    ...
    def test_get_service_info_basic_agent(self):
        ...
        self.assertEqual(
            config["output_field"], "output"
        )  # Explicitly set in test_context
