...
class TestLLMAgent(unittest.TestCase):
    ...
    def test_agent_initialization_with_minimal_context(self):
        ...
        minimal_agent = LLMAgent(name="minimal_llm", prompt="Simple prompt")
    ...
    def test_llm_service_error_when_not_configured(self):
        ...
        unconfigured_agent = LLMAgent(
            name="unconfigured", prompt="Test prompt", logger=self.mock_logger
        )
    ...
    def test_process_with_simple_prompt(self):
        ...
        self.assertEqual(
            user_msg["content"], "What is the capital of France?"
    ...
    def test_build_user_message_formatting(self):
        ...
        test_cases = [
            ...
            (
                {"prompt": "Question", "context": "Background"},
                "prompt: Question\ncontext: Background",
            ),
