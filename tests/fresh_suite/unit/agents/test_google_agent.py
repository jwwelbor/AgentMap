...
class TestGoogleAgent(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_llm_service.call_llm.return_value = "Mock Google/Gemini response for testing"
    ...
    def test_google_agent_backward_compatibility_context_preservation(self):
        ...
        self.assertEqual(agent.input_fields, ["prompt", "context", "memory"])  # memory added by LLMAgent
    ...
    def test_google_agent_process_integration(self):
        ...
        self.assertEqual(user_msg["content"], "What are the latest advances in AI research?")
    ...
    def test_google_agent_run_method_integration(self):
        ...
        self.assertEqual(result_state["response"], "Mock Google/Gemini response for testing")
    ...
    def test_google_agent_debug_logging_provider_info(self):
        ...
        self.assertTrue(provider_logged, f"Expected Google provider logged, got: {debug_messages}")
