...
class ResumeWorkflowUpdatedDiagnosisTest(unittest.TestCase):
    ...
    def test_resume_endpoint_existence(self):
        ...
        possible_endpoints = [
            ResumeEndpointTest(
                "/workflows/resume", 404, "Standard workflow resume endpoint"
            ),
            ResumeEndpointTest(
                "/api/v1/workflows/resume", 404, "Versioned workflow resume"
            ),
    ...
    def test_runtime_api_directly(self):
        ...
        try:
            ...
            result1 = runtime_resume_workflow(
                resume_token="test-thread-123", config_file=None
            )
        ...
        try:
            ...
            result2 = runtime_resume_workflow(
                resume_token=structured_token, config_file=None
            )
