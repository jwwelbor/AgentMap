...
class TestHostProtocolConfigurationService(unittest.TestCase):
    ...
    def test_configure_host_protocols_success(self):
        ...
        self.mock_registry.get_service_provider.return_value = lambda: "mock_service_instance"
        ...
        mock_agent.configure_test_service.assert_called_once_with("mock_service_instance")
    ...
    def test_configure_host_protocols_no_matching_protocols(self):
        ...
        # Set up registry
        self.mock_registry.list_registered_services.return_value = ["test_service"]
        self.mock_registry.get_service_protocols.return_value = [type('UnimplementedProtocol', (), {})]
    ...
    def test_get_configuration_status(self):
        ...
        # Set up registry
        self.mock_registry.list_registered_services.return_value = ["test_service", "other_service"]
        self.mock_registry.get_service_protocols.return_value = [MockProtocol]
    ...
    def test_error_handling_in_configure_host_protocols(self):
        ...
        self.mock_registry.list_registered_services.side_effect = Exception("Registry error")
