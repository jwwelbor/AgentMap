...
class TestWorkflowEndpoints(BaseAPIIntegrationTest):
    ...
    def _create_empty_repo_test_config(self, empty_repo_path: Path) -> Path:
        ...
        storage_config_data = {
            ...
            "csv": {"default_directory": empty_repo_path.name, "collections": {}},
        }
    ...
    def assert_response_success(
        self, response, expected_status: int = 200, message: str = ""
    ):
    ...
    def assert_response_contains_fields(
        self, response_data: dict, required_fields: list
    ):
...
"""
    ...
    def test_list_workflows_success(self):
        ...
        def run_test():
            ...
            data = response.json()
            self.assert_response_contains_fields(
                data, ["repository_path", "workflows", "total_count"]
            )
    ...
    @unittest.skip(
        "API endpoint for workflow details (without graph name) not yet implemented"
    )
    def test_get_workflow_details_success(self):
        ...
        def run_test():
            ...
            self.assertGreaterEqual(
                len(data["graphs"]), 2
            )  # Should have graph_a and graph_b

            for graph in data["graphs"]:
                self.assert_response_contains_fields(
                    graph, ["name", "node_count", "entry_point", "nodes"]
                )
    ...
    def test_get_workflow_details_not_found(self):
        ...
        def run_test():
            ...
            response = self.client.get(
                "/workflows/nonexistent_workflow", headers=headers
            )
    ...
    def test_get_workflow_details_invalid_name(self):
        ...
        def run_test():
            ...
            response = self.client.get(
                "/workflows/../../../etc/passwd", headers=headers
            )
            self.assert_response_error(response, 404)
    ...
    def test_get_graph_details_success(self):
        ...
        def run_test():
            headers = self.create_admin_headers(self.admin_api_key)
            response = self.client.get(
                "/workflows/complex_workflow/graph_a", headers=headers
            )
            ...
            self.assert_response_contains_fields(
                data, ["workflow", "graph", "nodes", "node_count", "entry_point"]
            )
            ...
            for node in data["nodes"]:
                self.assert_response_contains_fields(node, ["name", "agent_type"])
    ...
    def test_get_graph_details_workflow_not_found(self):
        ...
        def run_test():
            headers = self.create_admin_headers(self.admin_api_key)
            response = self.client.get(
                "/workflows/nonexistent_workflow/some_graph", headers=headers
            )
    ...
    def test_get_graph_details_graph_not_found(self):
        ...
        def run_test():
            headers = self.create_admin_headers(self.admin_api_key)
            response = self.client.get(
                "/workflows/simple_workflow/nonexistent_graph", headers=headers
            )
    ...
    def test_list_workflow_graphs_success(self):
        ...
        def run_test():
            headers = self.create_admin_headers(self.admin_api_key)
            response = self.client.get(
                "/workflows/complex_workflow/graphs", headers=headers
            )
            ...
            data = response.json()
            self.assert_response_contains_fields(
                data, ["workflow_name", "graphs", "total_graphs"]
            )
            ...
            for graph in data["graphs"]:
                self.assert_response_contains_fields(
                    graph, ["name", "node_count", "first_node"]
                )
                self.assertGreater(graph["node_count"], 0)
    ...
    def test_list_workflow_graphs_not_found(self):
        ...
        def run_test():
            headers = self.create_admin_headers(self.admin_api_key)
            response = self.client.get(
                "/workflows/nonexistent_workflow/graphs", headers=headers
            )
    ...
    def test_workflow_parsing_error_handling(self):
        ...
        def run_test():
            ...
            invalid_csv_path = (
                Path(self.temp_dir) / "storage" / "csv" / "invalid_workflow.csv"
            )
    ...
    def test_workflow_edge_cases(self):
        ...
        def run_test():
            ...
            response = self.client.get(
                "/workflows/edge_case_workflow/edge_graph", headers=headers
            )
    ...
    def test_workflow_concurrent_access(self):
        ...
        def run_test():
            ...
            def make_request():
                headers = self.create_admin_headers(self.admin_api_key)
                response = self.client.get(
                    "/workflows/simple_workflow", headers=headers
                )
