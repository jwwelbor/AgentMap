...
""".format(
    ...
    def assert_json_response(self, response, expected_status: int = 200):
        ...
        try:
            ...
            self.fail(
                f"Response is not valid JSON: {e}. Response text: {response.text}"
            )

    def assert_response_contains_fields(
        self, response_data: Dict[str, Any], required_fields: list
    ):
    ...
    def create_test_request_data(self, **kwargs) -> Dict[str, Any]:
        ...
        default_data = {"state": {"input_data": "test_input"}, "execution_id": None}
    ...
    def create_validation_request_data(self, **kwargs) -> Dict[str, Any]:
        ...
        default_data = {"csv_path": str(self.simple_csv_path), "no_cache": True}
        default_data.update(kwargs)
        return default_data
