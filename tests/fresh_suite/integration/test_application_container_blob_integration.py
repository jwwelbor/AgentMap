...
class TestApplicationContainerBlobIntegration(unittest.TestCase):
    ...
    def test_blob_storage_service_registration(self):
        ...
        self.assertIsNotNone(blob_service.configuration, "Configuration should be injected")
        self.assertIsNotNone(blob_service.logging_service, "LoggingService should be injected")
    ...
    def test_storage_service_manager_blob_integration(self):
        ...
        self.assertIsNotNone(storage_manager, "StorageServiceManager should be available")
    ...
    def test_blob_storage_service_dependency_chain(self):
        ...
        self.assertIsNotNone(storage_config_service, "StorageConfigService should be available")
    ...
    def test_storage_manager_blob_dependency_chain(self):
        ...
        self.assertTrue(storage_manager.is_blob_storage_enabled(), "Storage manager should have blob storage")
        manager_blob_service = storage_manager.get_blob_storage_service()
        self.assertIsNotNone(manager_blob_service, "Manager should provide blob storage service")
    ...
    def test_storage_manager_singleton_with_blob_integration(self):
        ...
        if manager1 is not None and manager2 is not None:
            ...
            if manager1.is_blob_storage_enabled():
                self.assertEqual(manager1.is_blob_storage_enabled(), manager2.is_blob_storage_enabled())
    ...
    def test_container_graceful_degradation_missing_blob_dependencies(self):
        ...
        self.assertIsNotNone(container.app_config_service(), "AppConfigService should be available")
        self.assertIsNotNone(container.logging_service(), "LoggingService should be available")
        ...
        providers = blob_service.get_available_providers()
        self.assertIn('file', providers, "Local file provider should always be available")
...
"""
    ...
    def test_container_resource_management_with_blob_services(self):
        ...
        self.assertIsNotNone(manager_blob, "Manager should provide blob storage service")
