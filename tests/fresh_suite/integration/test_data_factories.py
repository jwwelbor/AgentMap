...
class ConfigTestDataFactory:
    ...
    def create_storage_config(temp_dir: str) -> Dict[str, Any]:
        ...
        """
        return {
            "csv": {"default_directory": f"{temp_dir}/csv_storage", "collections": {}},
            "json": {
            ...
            "kv": {
                ...
                "collections": {
                    "test_kv": {
                        "provider": "local",
                        "settings": {"file_path": f"{temp_dir}/test_kv.json"},
                    }
                },
            },
            "vector": {
...
class ExecutionTestDataFactory:
    ...
    def create_complex_execution_state() -> Dict[str, Any]:
        ...
        return {
            ...
            "environment": {"test_mode": True, "debug_enabled": True},
        }
    ...
    def create_error_scenarios() -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "invalid_input": {"user_input": None, "session_id": "error_test_1"},
...
class IntegrationTestDataManager:
    ...
    def create_test_csv_file(
        self, graph_spec: TestGraphSpec, filename: str = None
    ) -> Path:
        """
    ...
    def create_multi_graph_csv_file(
        self, graph_specs: List[TestGraphSpec], filename: str = "multi_graph.csv"
    ) -> Path:
        """
    ...
    def setup_complete_test_environment(self) -> Dict[str, Path]:
        ...
        config_data = self.config_factory.create_full_integration_config(
            str(self.temp_dir)
        )
        ...
        conditional_csv_path = self.create_test_csv_file(
            conditional_graph, "conditional_test.csv"
        )

        multi_graphs = self.csv_factory.create_multi_graph_csv()
        multi_csv_path = self.create_multi_graph_csv_file(
            multi_graphs, "multi_graph_test.csv"
        )
