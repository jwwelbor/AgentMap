...
class TestGraphInterruptResumeSummary(unittest.TestCase):
    ...
    def test_all_components_importable(self):
        ...
        components_to_test = [
            ...
            ('agentmap.services.interaction_handler_service', 'InteractionHandlerService'),
    ...
    def test_workflow_structure_valid(self):
        ...
        checkpoint_data = {
            ...
            "agent_context": {"execution_id": "exec_123", "node_path": ["start", "test_node"]},
    ...
    def test_comprehensive_data_flow(self):
        ...
        checkpoint_data = {
            ...
            "intermediate_results": {"validation": "passed", "preprocessing": "complete"}
        }
        ...
        self.assertEqual(exception.checkpoint_data["execution_tracker"]["progress"], 0.5)
        self.assertEqual(exception.checkpoint_data["intermediate_results"]["validation"], "passed")
